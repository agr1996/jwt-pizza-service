...
test('login', async () => {
    const loginRes = await request(app).put('/api/auth').send(testUser); // will use lots of of awaits may forget one later and cause test error
